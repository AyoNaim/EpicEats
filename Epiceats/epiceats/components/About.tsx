  ...
  return (
    <section className='flex justify-center items-center w-screen h-screen'>
        <div className='w-11/12 h-5/6 flex gap-4 items-start flex-col'>
            <div className=''>
                <p className={`text-lg font-thin ${geistSans.className}`}>Welcome to <strong>Epiceats</strong></p>
            </div>
            <div className=''>
                <p className={`text-[30px] md:text-[50px] ${geistMono.className} tracking-tight leading-tight`}>
